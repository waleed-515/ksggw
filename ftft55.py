...
def menu(my_name,my_id):
	...
	print('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}\x1b[38;5;133m 𝑇𝐸l𝐸 \x1b[38;5;230m ⁞ \x1b[38;5;153m@R_M_D')
	print('\x1b[38;5;230m')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s ⚜️ 𝑹𝑴𝑨𝑫 ⚜️%s/%s » 🔹 𝐎𝐊  🧸 %s » 🧸 𝐶𝑃 🔹  %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
